...
extern char APP_DATA(squares, vma), APP_DATA(squares, lma), APP_DATA(squares, len);
...
extern char APP_BSS(squares, vma), APP_BSS(squares, lma), APP_BSS(squares, len);
...
int main(int argc, char **argv) {
	...
	load_section(&APP_DATA(squares, vma), &APP_DATA(squares, lma), (unsigned int) &APP_DATA(squares, len));
	...
	zero_bss_section(&APP_BSS(squares, vma), (unsigned int) &APP_BSS(squares, len));
